...
#line = LINE()
#line = LINE("เมล","พาส")
line = LINE('EzjAp3WelEVhQ1cT5YO5.CzCtl3/nkjhiEe9RCShRvq.OPF733MR4u4WEZvcPYA21cD08xQtSTwfx/gw7TvPFHc=')
...
╠   🇹🇭☣₱ᎬᎪ แมวเป้☣🇹🇭
╚══════════════┛
↪️คำสั่ง1= คำสั่งทั่วไป
↪️คำสั่ง2 = คำสั่งกลุ่ม
↪️คำสั่ง3 = คำสั่งการตั้งค่า
↪️คำสั่ง4 = คำสั่งมีเดีย
↪️คำสั่ง5 = คำสั่งสิริ
↪️คำสั่ง6 = คำสั่งแปลภาษา
🇹🇭☣₱ᎬᎪ แมวเป้☣🇹🇭"""
    return myHelp
...
#==============================================================================#
                    ...
                    for g in gs.members:
                        ...
                        line.createGroup("🇹🇭☣₱ᎬᎪ แมวเป้☣🇹🇭",[key])
                        line.sendText(msg,to,"➠ทำการรัน สำเร็จ")
       ...
       #             line.sendMessage(msg.to,"➠ปิดแทค คนแทคกลับ")
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "🇹🇭☣₱ᎬᎪ แมวเป้☣🇹🇭\nตั้งข้อความเมื่อมีคนแอด\n\n{}".format(str(spl)))
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
                if msg.text in ["55","555","5555","55555","55+","555+","5555+","ขำ","ขำๆ"]:
                    line.sendText(msg.to,"เป้ว่าไปหาหมอบ้างนะ อิอิ😝😝")
          #  if settings ["Api"] == True:
